if __name__ == "__main__":
    ...
    ai_algo = NegamaxAB(1, pruning=True, mode='negamax')    # can be modified - available modes: negamax or expecti
    ...
    for i in range(100):
        ...
        _, loser, winner, nmove = TicTacToe([AI_Player(ai_algo), AI_Player(ai_algo2)], first_player=1)\
            .play(verbose=False, possible_loss=False) # possible_loss=True is stochastic variant
        end = time.time()
        wins.append(winner)
